                    ...
                    <c:otherwise>
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal" name="login" id="flogin" action="EditarVisita" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input required="true" type="text" class="form-control" name="fecha" id="fecha" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${visita.fecha!=null ? visita.fecha : fech}" />">                   
                                </div>
                            </div>
